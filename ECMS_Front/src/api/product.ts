...
export function getProductList(params: ProductQueryParams) {
  return request.get<ApiResult<PageResult<SpuItem>>>(BASE_URL, { params })
}
...
export function getProductDetail(id: number) {
  return request.get<ApiResult<SpuItem>>(`${BASE_URL}/${id}`)
}
...
export function createProduct(data: Partial<SpuItem>) {
  return request.post<ApiResult<SpuItem>>(BASE_URL, data)
}
...
export function updateProduct(id: number, data: Partial<SpuItem>) {
  return request.put<ApiResult<SpuItem>>(`${BASE_URL}/${id}`, data)
}
...
export function deleteProduct(id: number) {
  return request.delete<ApiResult<null>>(`${BASE_URL}/${id}`)
}
...
export function batchDeleteProducts(ids: number[]) {
  return request.post<ApiResult<null>>(`${BASE_URL}/batch-delete`, { ids })
}
...
export function onShelfProduct(id: number) {
  return request.put<ApiResult<null>>(`${BASE_URL}/${id}/on-shelf`)
}
...
export function offShelfProduct(id: number) {
  return request.put<ApiResult<null>>(`${BASE_URL}/${id}/off-shelf`)
}
...
export function getSkuList(spuId: number) {
  return request.get<ApiResult<SkuItem[]>>(`${BASE_URL}/${spuId}/skus`)
}
...
export function updateSku(spuId: number, skuId: number, data: Partial<SkuItem>) {
  return request.put<ApiResult<SkuItem>>(`${BASE_URL}/${spuId}/skus/${skuId}`, data)
}
...
export function batchUpdateSkus(spuId: number, skus: Partial<SkuItem>[]) {
  return request.put<ApiResult<null>>(`${BASE_URL}/${spuId}/skus/batch`, { skus })
}
...
export function getInventoryLogs(spuId: number, params: { page: number; pageSize: number; changeType?: number }) {
  return request.get<ApiResult<{ records: InventoryLog[]; total: number }>>(`${BASE_URL}/${spuId}/inventory-logs`, { params })
}
...
export function getStatusLogs(spuId: number) {
  return request.get<ApiResult<StatusLog[]>>(`${BASE_URL}/${spuId}/status-logs`)
}
...
export function getAuditLogs(spuId: number) {
  return request.get<ApiResult<AuditLog[]>>(`${BASE_URL}/${spuId}/audit-logs`)
}
...
export function getSkuInventory(spuId: number) {
  return request.get<ApiResult<SkuItem[]>>(`${BASE_URL}/${spuId}/inventory`)
}
...
export function exportProducts(params: Partial<ProductQueryParams>) {
  return request.get<Blob>(`${BASE_URL}/export`, { params, responseType: 'blob' })
}
